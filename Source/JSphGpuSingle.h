...
protected:
  ...
  void SaveVtkData(std::string fname,unsigned num,unsigned np,const double2 *posxy,const double *posz,const unsigned *idp,const double3 *velrhop,const double *pressure)const;
  void SaveData();
