...
public:
  ...
  void SortBasicArrays(const unsigned *idp,const word *code,const unsigned *dcell,const double2 *posxy,const double *posz,const float4 *velrhop,const double3 *velocity,const double *pressure,unsigned *idp2,word *code2,unsigned *dcell2,double2 *posxy2,double *posz2,float4 *velrhop2,double3 *velocity2,double *pressure2);
  ...
  void SortDataArrays(const double2 *a,const double *b,const float4 *c,double2 *a2,double *b2,float4 *c2);
	void SortDataArrays(const double2 *a,const double *b,const float4 *c,const double3 *d,double2 *a2,double *b2,float4 *c2,double3 *d2);
